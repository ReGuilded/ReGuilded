        ...
        return (
            <ErrorBoundary>
                <div className="OptionsMenuPageWrapper-container">
                    <div className="TeamDocs-container ReGuildedExtensions-container DocChannel-team-docs ContentLoader-container ContentLoader-container-vertically-centered" style={{paddingLeft: "32px"}}>
