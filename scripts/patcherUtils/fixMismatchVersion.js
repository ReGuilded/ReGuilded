...
module.exports = (guildedPackage, reguildedPackage) => {
    ...
    if (reguildedPackageJSON.version !== guildedPackage.version) {
        ...
        else writeFileSync(reguildedPackage, packageJson);
        console.warn(
            "There was a mismatch version between ReGuilded and Guilded. If you're seeing this, we've successfully fixed this, and all you need to do is relaunch Guilded."
        );
